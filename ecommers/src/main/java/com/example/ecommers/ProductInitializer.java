...
public class ProductInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        if (i_productRepository.count() == 0) {
            ...
            ProductEntity product = new ProductEntity(1L,"Logitech rx pro",4,"https://s3-sa-east-1.amazonaws.com/saasargentina/oaPmQNJPQeMZynN9AOk5/imagen",500,true,category);
            ...
            ProductEntity product2 = new ProductEntity(2L,"Razer elite v1",14,"https://www.trustedreviews.com/wp-content/uploads/sites/54/2021/07/Best-gaming-keyboard-920x613.jpg",1500,true,category2);
            ...
            ProductEntity product3 = new ProductEntity(3L,"Kingston 8GB ddr4",10,"https://www.venex.com.ar/products_images/1599918773_8gb.jpg",3500,true,category3);
            ...
            ProductEntity product4 = new ProductEntity(4L,"Intel i9-9900k",3,"https://app.contabilium.com/files/explorer/7026/Productos-Servicios/concepto-6303558.jpg",10500,true,category4);
            ...
            ProductEntity product5 = new ProductEntity(5L,"Nvidia Radeon 5550xt",1,"https://www.igorslab.de/wp-content/uploads/2020/01/Intro.jpg",13500,true,category5);
